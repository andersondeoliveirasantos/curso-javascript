...
console.log('Preciso de uma planilha de follow up de compras')
console.log('Quero dominar os pedidos de Follow Up dos clientes')
console.log('É fácil de aprender')
console.log('Respostas rápidas')
console.log('Hoje, não consegui estudar, estava cm dor de cabeça.')
